...
public class Feedback {
	...
	public Feedback(Survey survey, LocalDateTime postedDateTime, Participant participant,
			Map<Long, Option> chosenAnswers) {
	...
	public Feedback(LocalDateTime postedDateTime, Map<Long, Option> chosenAnswers) {

		this.postedDateTime = postedDateTime;
		this.chosenAnswers = chosenAnswers;
	}

	public Feedback(Survey survey2, LocalDateTime postedDateTime2, Participant participant2) {
	...
	public String toString() {
		return "Feedback [id=" + id + ", survey=" + survey.getId() + ", postedDateTime=" + postedDateTime
				+ ", participant=" + participant.getUsername() + ", chosenAnswers=" + chosenAnswers + "]";
	}
